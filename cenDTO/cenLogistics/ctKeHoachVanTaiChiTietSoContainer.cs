...
namespace cenDTO
{
    public class ctKeHoachVanTaiChiTietSoContainer
    {
        public const string tableName = "ctKeHoachVanTai";
        public const string listProcedureName = "List_" + tableName + "ChiTietSoContainer";
        ...
        public class ctKeHoachVanTaiChiTietSoContainerChiTiet
        {
            public string ID { get; set; }
            public string IDDanhMucDonVi { get; set; }
            public string IDDanhMucChungTu { get; set; }
            ...
            public const string tableName = "ctKeHoachVanTaiChiTietSoContainer";
            public const string insertProcedureName = "Insert_" + tableName;
            public const string updateProcedureName = "Update_" + tableName;
            public const string deleteProcedureName = "Delete_" + tableName;

        }
        public List<ctKeHoachVanTaiChiTietSoContainerChiTiet> listChiTiet;

        //
        public ctKeHoachVanTaiChiTietSoContainer()
        {
            ID = null;
            IDDanhMucDonVi = null;
