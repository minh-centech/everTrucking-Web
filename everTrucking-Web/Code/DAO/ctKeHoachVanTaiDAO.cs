    ...
    public class ctKeHoachVanTaiDAO
    {
        ...
        public string Insert(ctKeHoachVanTai obj)
        {
            ...
            try
            {
                ...
                sqlParameters[33] = new SqlParameter("@IDDanhMucNguoiSuDungCreate", Code.GlobalVariables.IDDanhMucNguoiSuDung);
                ...
                using (SqlConnection sqlConnection = new SqlConnection(Code.GlobalVariables.webConnectionString))
                {
                    ...
                    using (SqlTransaction sqlTransaction = sqlConnection.BeginTransaction())
                    {
                        using (SqlCommand sqlCommand = new SqlCommand(ctKeHoachVanTai.deleteProcedureName, sqlConnection, sqlTransaction))
                        {
                            ...
                            sqlParameters[1] = new SqlParameter("@IDDanhMucNguoiSuDungDelete", Code.GlobalVariables.IDDanhMucNguoiSuDung);
